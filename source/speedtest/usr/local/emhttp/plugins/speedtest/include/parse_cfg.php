...
$speedtest_server   = isset($speedtest_cfg['SERVER'])  ? htmlspecialchars($speedtest_cfg['SERVER'])  : 'none';
...
$speedtest_version  = isset($speedtest_cfg['VERSION']) ? htmlspecialchars($speedtest_cfg['VERSION']) : '1.0.2';
