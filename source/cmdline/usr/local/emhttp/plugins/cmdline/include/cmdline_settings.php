...
$shellinabox_port_status = ($shellinabox_running) ? 
	"<a target='_blank' href='".$shellinabox_http."://".$shellinabox_host.":".$shellinabox_port."' title='Click on link then accept security, then /Tools/CommandLine will work'><b><font color='green'>$shellinabox_port</font></b></a>":
